...
public class Viaje {
	...
	public Viaje(int id, float precio, Date fechaInicio, Date fechaFin, LocalTime horaInicio, LocalTime horaFin, Localidad localidadOrigen, Localidad localidadDestino) {
		super();
		this.id = id;
		this.precio = precio;
